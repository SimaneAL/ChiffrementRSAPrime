...
public class Controller implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        this.file = null;
        this.notifs.setText("Hello ! You can start choosing two numbers p and q ! Or wanna just press the button calculate random ones ");
    ...
    void decrypte(ActionEvent event) {
        ...
        this.notifs.setText("Your encrypted message has been decrypted !");
    ...
    void validateRandom(ActionEvent event) {
        ...
        this.notifs.setText("Gr8 ! The machine choose random p and q for you, now you just have to enter a message to encrypte it ! Or just chose a file  ");
    ...
    void choseFile(ActionEvent event){
        ...
        this.notifs.setText("It's time to encrypte your file ! Press the button encrypte");
